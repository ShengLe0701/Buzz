...
import './CardPostDestaque.styl';
import style from './style';
import Paper from 'material-ui/Paper'

class CardPostDestaque extends Component {
		...
		return(
			<Paper
				...
				<div className="legenda-holder">
					...
					<div className="resumo">{post.resumo ? post.resumo : ''}</div>
					{/* <div className="tags">
...
export default CardPostDestaque;
